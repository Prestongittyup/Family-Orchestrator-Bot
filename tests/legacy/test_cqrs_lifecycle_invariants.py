...
def test_fsm_is_sole_mutation_authority():
    ...
    fsm_path = REPO_ROOT / "apps" / "api" / "core" / "state_machine.py"
...
def test_reducer_validates_using_fsm_rules():
    ...
    """
    reducer_path = REPO_ROOT / "household_os" / "runtime" / "state_reducer.py"
...
def test_api_uses_lifecycle_presentation_mapper():
    ...
    """
    api_path = REPO_ROOT / "apps" / "api" / "assistant_runtime_router.py"
...
def test_presentation_mapper_is_read_only():
    ...
    mapper_path = REPO_ROOT / "household_os" / "presentation" / "lifecycle_presentation_mapper.py"
...
def test_no_normalize_state_mutations():
    ...
    lifecycle_state_path = REPO_ROOT / "household_os" / "core" / "lifecycle_state.py"
