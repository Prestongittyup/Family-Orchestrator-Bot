...
@pytest.mark.integration
@pytest.mark.legacy
def test_handle_email_received_informational_without_attention_skips_task(monkeypatch: pytest.MonkeyPatch) -> None:
    create_task_called = {"value": False}
    ...
    payload = EmailReceivedEvent(
        ...
        state_summary="Statement posted for records.",
        importance_bucket="low",
    ...
    assert result["status"] == "email_informational"
