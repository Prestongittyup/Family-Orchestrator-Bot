...
class PantryIngredientRequirement(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class PantryRecipeSuggestion(BaseModel):
    ...
    ingredient_requirements: list[PantryIngredientRequirement] = Field(default_factory=list)
    ingredients_used: list[str] = Field(default_factory=list)
    missing_ingredients: list[str] = Field(default_factory=list)
    nutrition_balance: list[str] = Field(default_factory=list)
    inventory_match_score: float
...
class PantryState(BaseModel):
    ...
    inventory_items: list[PantryInventoryItem] = Field(default_factory=list)
    weekly_recipe_suggestions: list[PantryRecipeSuggestion] = Field(default_factory=list)
    grocery_recommendations: list[str] = Field(default_factory=list)
...
class UIBootstrapState(BaseModel):
    ...
    pantry: PantryState = Field(default_factory=PantryState)
