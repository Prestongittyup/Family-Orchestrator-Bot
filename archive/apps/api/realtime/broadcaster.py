...
from archive.apps.api.observability.metrics import metrics, timer
from archive.apps.api.observability.logging import log_event, log_error
from archive.apps.api.observability.alerts import (
    check_resync_spike,
    signal_watermark_collision,
    signal_replay_gap,
    signal_duplicate_emission,
)
import archive.apps.api.observability.logging as observability_logging
from archive.apps.api.realtime.event_bus import (
    InMemoryRealtimeEventBus,
    RedisRealtimeEventBus,
    RealtimeEventBus,
)
from archive.apps.api.realtime.transport_event import RealtimeEvent
from archive.apps.api.runtime.loop_tracing import register_loop_resource, trace_loop_binding, trace_loop_context
...
class HouseholdBroadcaster:
    ...
    async def publish(self, envelope: CanonicalEventEnvelope) -> None:
        ...
        from archive.apps.api.observability.safety import safety
