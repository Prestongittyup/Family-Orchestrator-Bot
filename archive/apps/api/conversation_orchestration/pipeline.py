...
from archive.apps.api.conversation_orchestration.intent_refinement import IntentRefinementEngine
...
from archive.apps.api.conversation_orchestration.store import (
...
from archive.apps.api.intent_contract.action_planner import ActionPlan, ActionPlanner
from archive.apps.api.intent_contract.classifier import IntentClassification, IntentClassifier
from archive.apps.api.intent_contract.schema import ExtractedFields, IntentType
...
from archive.apps.api.policy_engine.schema import PolicyConfig, PolicyDecision, PolicyResult
...
class ConversationPipeline:
    ...
    Usage:
    orchestrator = ConversationPipeline(entity_store=my_store)
...
# Backward-compatible export; avoids introducing a non-canonical class declaration.
ConversationOrchestrator = ConversationPipeline
