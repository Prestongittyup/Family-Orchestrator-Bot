...
from archive.apps.api.core.audit_bypass import is_audit_bypass_request
from archive.apps.api.runtime.execution_fairness import fairness_gate, RequestClass, get_loop_local_resource
...
def _classify(path: str) -> RequestClass:
    ...
    if any(normalized.startswith(p) for p in _SHORT_PREFIXES):
        return "SHORT"
    return "LONG"
